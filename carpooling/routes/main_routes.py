...
@main_blueprint.route('/verify_auth_key/<next>/<kwargs_keys>/<kwargs_string>', methods=['GET', 'POST'])
...
@main_blueprint.route('/valid-auth-keys')
@admin_required
...
@main_blueprint.route('/passenger-signup/<carpool_index>', methods=['GET', 'POST'])
...
@main_blueprint.route('/register-passenger', methods=['GET', 'POST'])
...
@main_blueprint.route('/legacy-driver-to-current', methods=['GET', 'POST'])
...
@main_blueprint.route('/generic-register', methods=['GET', 'POST'])
...
@main_blueprint.route('/login-help')
def login_help_page():
    """
...
@main_blueprint.route('/update-user', methods=['GET', 'POST'])
@login_required
...
@login_required
@main_blueprint.route('/cancel-carpool/<carpool_id>')
...
@main_blueprint.route('/leave-carpool/<carpool_id>')
@login_required
...
@main_blueprint.route('/change-carpool-destination', methods=['GET', 'POST'])
@login_required
...
@main_blueprint.route('/forgot-password', methods=['GET', 'POST'])
...
@main_blueprint.route('/reset-password/<user_id>/<token>', methods=['GET', 'POST'])
...
@main_blueprint.route('/convert-to-driver', methods=['GET', 'POST'])
@login_required
...
@main_blueprint.route('/manage-users')
@admin_required
...
@main_blueprint.route('/admin-delete-user/<user_id>')
@admin_required
...
@main_blueprint.route('/delete-event/<event_index>')
@login_required
