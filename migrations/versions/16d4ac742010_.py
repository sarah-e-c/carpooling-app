...
def downgrade():
    ...
    SELECT old_users.id, old_users.last_name, old_users.first_name, old_users.phone_number, old_users.email_address, old_users.emergency_contact_number, old_users.emergency_contact_relation, old_users.extra_information, old_users.region_name, addresses.address_line_1, addresses.address_line_2, addresses.city, addresses.zip_code
    FROM old_users
